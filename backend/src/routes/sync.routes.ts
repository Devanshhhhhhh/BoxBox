...
import { syncDrivers, syncMeetings, syncSessions, syncResults, syncLaps, syncPits, syncStints, syncWeather} from "../controllers/sync.controller"
...
router.post("/weathers", syncWeather);
